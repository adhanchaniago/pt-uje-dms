<?php 
	...
	$muat_no_spb = sanitizeThis($_POST['muat_no_spb']);
	...
	$bongkar_no_spb = sanitizeThis($_POST['bongkar_no_spb']);
	...
	$query = "INSERT INTO tb_spb (jalan_detail_id, muat_no_spb, muat_tanggal, muat_total_muatan, muat_berat_keseluruhan, bongkar_no_spb, bongkar_tanggal, bongkar_total_muatan, bongkar_berat_keseluruhan) VALUES('$jalan_detail_id', '$muat_no_spb', '$muat_tanggal', '$muat_total_muatan', '$muat_berat_keseluruhan', '$bongkar_no_spb', '$bongkar_tanggal', '$bongkar_total_muatan', '$bongkar_berat_keseluruhan')";
